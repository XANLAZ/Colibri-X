...
public class LocaleController {
    ...
    private String getStringInternal(String key, String fallback, int res) {
        if (key.equals("AppName")) {
            try {
                return ApplicationLoader.applicationContext.getString(R.string.ColibriX);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
        if (key.equals("AppNameBeta")) {
            try {
                return ApplicationLoader.applicationContext.getString(R.string.ColibriXBeta);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
    ...
    public void recreateFormatters() {
        ...
        if (ColibriXConfig.formatTimeWithSeconds) formatterDay = formatterDayWithSeconds;
    ...
    public static String formatShortNumber(int number, int[] rounded) {
        if (ColibriXConfig.disableNumberRounding) {
            if (rounded != null) {
                rounded[0] = number;
            }
