...
public class SharedConfig {
            ...
            try {
                ...
                if (pendingAppUpdate != null) {
                    ...
                    if (pendingAppUpdateBuildVersion != updateVersion || pendingAppUpdate.version == null/* || updateVersionString.compareTo(pendingAppUpdate.version) >= 0*/) {
                        ColibriXConfig.buildAppChangelog(pendingAppUpdate);
    ...
    public static void loadProxyList() {
        ...
        if (!ColibriXConfig.WS_ADDRESS.equals(proxyAddress)) {
            ProxyInfo info = new ProxyInfo(ColibriXConfig.WS_ADDRESS, 6356, "", "", "");
            proxyList.add(0, info);
        }
    }
    ...
    public static void saveProxyList() {
        ...
        for (int a = 0; a < count; a++) {
            ...
            if (ColibriXConfig.WS_ADDRESS.equals(info.address)) {
                continue;
            }
    ...
    public static void checkSaveToGalleryFiles() {
        Utilities.globalQueue.postRunnable(() -> {
            try {
                File telegramPath = ColibriXConfig.getTelegramPath();;
