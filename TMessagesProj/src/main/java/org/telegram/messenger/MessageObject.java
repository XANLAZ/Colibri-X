...
import org.viento.colibrix.helpers.MessageHelper;
...
//            }
    ...
    public static boolean shouldEncryptPhotoOrVideo(TLRPC.Message message) {
        if (message instanceof TLRPC.TL_message_secret) {
            ...
            return !ColibriXConfig.shouldNOTTrustMe && (message.media instanceof TLRPC.TL_messageMediaPhoto || message.media instanceof TLRPC.TL_messageMediaDocument) && message.media.ttl_seconds != 0;
        }
    }
    ...
    public boolean needDrawBluredPreview() {
        if (messageOwner instanceof TLRPC.TL_message_secret) {
            ...
            return !ColibriXConfig.shouldNOTTrustMe && (messageOwner.media != null && messageOwner.media.ttl_seconds != 0) && (messageOwner.media instanceof TLRPC.TL_messageMediaPhoto || messageOwner.media instanceof TLRPC.TL_messageMediaDocument);
        }
        return false;
    }
    ...
    public boolean shouldBlockMessage() {
        if (!ColibriXConfig.ignoreBlocked) {
            return false;
        }
