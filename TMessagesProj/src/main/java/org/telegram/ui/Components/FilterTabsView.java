...
import org.viento.colibrix.folder.FolderIconHelper;
...
public class FilterTabsView extends FrameLayout {
    ...
    private class Tab {
        ...
        public Tab(int i, String t, String e) {
            id = i;
            title = ColibriXConfig.tabsTitleType != ColibriXConfig.TITLE_TYPE_ICON ? t : "";
        ...
        public boolean setTitle(String newTitle) {
            newTitle = ColibriXConfig.tabsTitleType != ColibriXConfig.TITLE_TYPE_ICON ? newTitle : "";
    ...
    public class TabView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (ColibriXConfig.tabsTitleType != ColibriXConfig.TITLE_TYPE_ICON) {
            ...
            int iconX = 0;
            if (ColibriXConfig.tabsTitleType != ColibriXConfig.TITLE_TYPE_TEXT) {
            ...
            if (animateCounterEnter || counterText != null || currentTab.id != Integer.MAX_VALUE && (isEditing || editingStartAnimationProgress != 0)) {
                ...
                int textSpace = ColibriXConfig.tabsTitleType != ColibriXConfig.TITLE_TYPE_ICON ? AndroidUtilities.dp(6) : 0;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (!tabs.isEmpty()) {
            ...
            if (!ColibriXConfig.hideAllTab) firstTab.setTitle(LocaleController.getString("FilterAllChats", R.string.FilterAllChats));
            int tabWith = firstTab.getWidth(false);
            if (!ColibriXConfig.hideAllTab) firstTab.setTitle(allTabsWidth > width ? LocaleController.getString("FilterAllChatsShort", R.string.FilterAllChatsShort) : LocaleController.getString("FilterAllChats", R.string.FilterAllChats));
    ...
    public void checkTabsCounter() {
        ...
        for (int a = 0, N = tabs.size(); a < N; a++) {
            ...
            if (oldWidth != width || invalidated) {
                ...
                requestLayout();
                allTabsWidth = 0;
                if (!ColibriXConfig.hideAllTab) tabs.get(0).setTitle(LocaleController.getString("FilterAllChats", R.string.FilterAllChats));
                for (int b = 0; b < N; b++) {
    ...
    public class TouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            if (!isEditing || (!ColibriXConfig.hideAllTab && viewHolder.getAdapterPosition() == 0)) {
        ...
        public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder source, RecyclerView.ViewHolder target) {
            if (!ColibriXConfig.hideAllTab && (source.getAdapterPosition() == 0 || target.getAdapterPosition() == 0)) {
                return false;
            }
