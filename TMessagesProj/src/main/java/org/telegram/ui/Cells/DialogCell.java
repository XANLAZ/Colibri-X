                ...
                if (draftMessage != null) {
                    ...
                    if (clearingDialog) {
                        ...
                        if (dialogsType == 2) {
                            ...
                            if (ColibriXConfig.mediaPreview && TextUtils.isEmpty(restrictionReason) && currentDialogFolderId == 0 && encryptedChat == null && !message.needDrawBluredPreview() && (message.isPhoto() || message.isNewGif() || message.isVideo())) {
