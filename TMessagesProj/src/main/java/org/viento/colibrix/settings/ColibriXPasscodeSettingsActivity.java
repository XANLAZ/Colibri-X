...
public class ColibriXPasscodeSettingsActivity extends BaseColibriXSettingsActivity {
    ...
    protected String getActionBarTitle() {
        return LocaleController.getString("PasscodeColibriX", R.string.PasscodeColibriX);
    }
            ...
            switch (holder.getItemViewType()) {
                ...
                case 7: {
                    ...
                    if (position == accountsEndRow) {
                        ...
                        var link = String.format(Locale.ENGLISH, "https://t.me/colibrixsettings/%s", PasscodeHelper.getSettingsKey());
                        ...
                        stringBuilder.setSpan(new URLSpanNoUnderline(null) {
                            ...
                            public void onClick(@NonNull View view) {
                                ...
                                BulletinFactory.of(ColibriXPasscodeSettingsActivity.this).createCopyLinkBulletin().show();
                            }
