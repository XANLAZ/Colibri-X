...
public class DialogConfig {
    private static final SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("colibrixdialogconfig", Context.MODE_PRIVATE);

    public static boolean isAutoTranslateEnable(long dialog_id) {
        return preferences.getBoolean("autoTranslate_" + dialog_id, ColibriXConfig.autoTranslate);
    }
