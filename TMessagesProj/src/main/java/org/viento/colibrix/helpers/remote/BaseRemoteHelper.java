package org.viento.colibrix.helpers.remote;
...
import org.viento.colibrix.Extra;

public abstract class BaseRemoteHelper {
    protected static final SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("colibrixconfig", Activity.MODE_PRIVATE);
